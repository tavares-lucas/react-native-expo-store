...
import CollectionThumbFour from './../../resources/components/collection/CollectionThumbFour'
...
class CollectionListFour extends Component {
    static navigationOptions = {
        drawerLabel: 'Collection List Four Block',
    ...
    _renderList(data) {
        return (
            <View>
                {
                    data.map((item, idx) => {
                       return <CollectionThumbFour key={ idx } { ...item } onPress={() => this.onPressCollection()}/>
                    })
                }
            </View>
        )
    ...
    render() {
        return (
            <Container>
                ...
                <ScrollView>
                    { this._renderList(collections.data_four) }
                </ScrollView>
            </Container>
        )
    }
...
module.exports = CollectionListFour
